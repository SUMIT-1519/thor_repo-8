...
class GUI extends React.Component {
    componentDidMount () {
        ...
        console.log("Opening modal after 30 sec...");
        this.props.rawDispatch(openTask8Modal());
        this.closeTimer = setTimeout(() => {
            console.log("Closing modal after 10 sec...");
            this.props.rawDispatch(closeTask8Modal());
        }, 10000);
    }, 30000);
    ...
    render () {
        ...
        return (
            <GUIComponent
                ...
                {...componentProps}
                openTask8Modal={this.props.openTask8Modal}
                closeTask8Modal={this.props.closeTask8Modal}
                isTask8ModalOpen={this.props.isOpen}
            >
                {children}
            </GUIComponent>
        );
...
const mapStateToProps = state => {
    ...
    return {
        ...
        isOpen: state.scratchGui.task8Modal && state.scratchGui.task8Modal.isOpen
...
const mapDispatchToProps = dispatch => ({
    ...
    openTask8Modal: () => dispatch(openTask8Modal()),     
